...
public class MQProducerManager extends MQClientManager {
    ...
    public MQProducerManager(String username, String password, String destination, DESTTYPE type) {
        super(username, password, destination, type);
    }

    public MQProducerManager(String username, String password, String destination, DESTTYPE type, Integer liveSecs,
